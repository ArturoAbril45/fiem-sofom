        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
          <div style={{ position: 'relative' }}>
            ...
            <div style={{ position: 'relative' }}>
              ...
              <input value={busCliente} onChange={e => { setBusCliente(e.target.value); setForm(p => ({ ...p, clienteNombre: e.target.value })); setShowDrop(true); }} onFocus={() => setShowDrop(true)} placeholder="Buscar por nombre o CURP..." style={{ ...inp(errors.clienteNombre), paddingLeft: '36px' }} />
            </div>
